...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Datos del primer restaurante: " + orderManager.getRestaurant(0).getName() + ", teléfono: " + orderManager.getRestaurant(1).getPhone().getNumber());
    ...
    public static void init(OrderManager orderManager){
        ...
        Restaurant restaurant1 = new Restaurant("Pizzeria Sole", new Phone("111222333"));
